...
class CityscapesSegmentation(data.Dataset):
    ...
    def __init__(self, crop_size, base_size, root='../datasets/cityscapes/', split="train"):
...
#         self.args = args
        ...
        self.annotations_base = os.path.join(self.root, 'gtFine', self.split) # 'gtFine_trainvaltest',
