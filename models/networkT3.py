...
class make_ASPPModule(nn.Module):
    def __init__(self, inplanes, planes, kernel_size, padding, dilation, BatchNorm):
        ...
        super(make_ASPPModule, self).__init__()
...
class DeepLab(nn.Module):
    def __init__(self, backbone='resnest', output_stride=16, num_classes=21, freeze_bn=False):
        ...
        # double dim
#         self.upsample = nn.ConvTranspose2d(2048, 1024, kernel_size=2, stride=2) # reduce
            
        self.aspp = ASPP(output_stride, BatchNorm, workplanes=256, inplanes=2048)
